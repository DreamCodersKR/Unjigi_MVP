export function Greeting() {
  return (
      <section className="relative mb-8 overflow-hidden rounded-lg border border-orange-100 bg-gradient-to-r from-orange-50/80 via-white to-white px-4 py-5 shadow-sm">
